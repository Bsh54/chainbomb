...
export class Menu {
  ...
  render(canvasContext: CanvasContext): void {
    ...
    canvasContext.ctx.fillText('CHAINBOMB', canvasContext.screenWidth / 2, 50);

    canvasContext.ctx.shadowColor = '#00ffff';
    canvasContext.ctx.fillStyle = '#00ffff';
    canvasContext.ctx.fillText('CHAINBOMB', canvasContext.screenWidth / 2 - 2, 48);

    canvasContext.ctx.shadowBlur = 0;
    canvasContext.ctx.fillStyle = '#ffffff';
    canvasContext.ctx.fillText('CHAINBOMB', canvasContext.screenWidth / 2 - 1, 49);
